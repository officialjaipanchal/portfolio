...
// Toggle function for coursework
function toggleCoursework(courseworkId) {
  const content = document.getElementById(courseworkId);
  const button = content.previousElementSibling;
  
  if (content.style.display === "none" || content.style.display === "") {
    content.style.display = "grid";
    button.classList.add("active");
    button.querySelector("span:first-child").textContent = "Hide Coursework";
  } else {
    content.style.display = "none";
    button.classList.remove("active");
    button.querySelector("span:first-child").textContent = "View Coursework";
  }
}

// Toggle function for other experience
function toggleOtherExperience() {
  const content = document.getElementById('other-experience');
  const button = content.previousElementSibling;
